...
class Follow_points(AgentThread):
    ...
    def __init__(self, config, motion_config):
        ...
        self.waypoints = [[(-64.0, -66.0, 1.0), (-64.0, -59.0, 1.0), (-39.5, -59.0, 1.0), (-39.5, -59.0, 1.0), (-39.5, -66.0, 1.0), (-84, -64, 0.3)],
                          [(-64.0, -66.0, 1.0), (-64.0, -59.0, 1.0), (-39.5, -59.0, 1.0), (-39.5, -59.0, 1.0), (-39.5, -66.0, 1.0), (-84, -66, 0.3)],
                          [(-64.0, -66.0, 1.0), (-64.0, -59.0, 1.0), (-39.5, -59.0, 1.0), (-39.5, -59.0, 1.0), (-39.5, -66.0, 1.0), (-84, -68, 0.3)]]
